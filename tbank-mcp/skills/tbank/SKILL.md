...
- Before placing image URLs from a tool result directly into visible chat,
  ...
  Hotel tools intentionally return source URLs without native image blocks or
  data URIs. Do not make sequential calls per image.
  `get_trip_report(output_mode="html")`
