...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "get_trip_report": "Собирает поездку из request с транспортом, flightOptions и отелями и возвращает html или markdown по output_mode. Сервер повторно проверяет предложения; файлов, бронирования и оплаты нет.",
