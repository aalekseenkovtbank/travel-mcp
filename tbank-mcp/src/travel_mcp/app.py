...
def _travel_server_instructions() -> str:
    return (
        ...
        "В chat-ответе hotel_search используй строгий табличный comparisonMarkdown "
        "hotel-chat/v2 без перестановки или переименования секций: краткое "
        "сравнение, таблицу деталей, трёхколоночную фотогалерею и таблицу обзора "
