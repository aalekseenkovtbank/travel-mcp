...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "get_trip_report": "Валидирует request trip-page/v2 или hotel-page/v1 и возвращает html или markdown по output_mode. До вызова получи события прямым afisha_catalog по городу и датам, без предварительного search_app, и передай их в request.events. Поисковые данные перепроверяются до отчёта; файлов, бронирования и оплаты нет.",
