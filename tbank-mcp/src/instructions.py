...
def server_instructions() -> str:
    ...
    return (
        ...
        "первых comparison_limit карточек. Если выбираешь другие отели из hotels, "
        "обогати их через hotel_latest_offers, hotel_rates и hotel_reviews. В "
        ...
        "элемента не показаны. Для HTML или Markdown после этого "
