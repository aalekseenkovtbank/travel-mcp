...
def server_instructions() -> str:
    ...
    return (
        ...
        "элемента не показаны. hotel_search также прикладывает по одному "
        "нативному MCP image-блоку на отель, но такой блок может остаться "
        "только внутри tool result и не заменяет фото в финальном ответе. "
