...
def server_instructions() -> str:
    ...
    return (
        ...
        "и нужный узкий travel-skill. Каждый hotel-тул возвращает встроенный "
        "details с карточкой и фотографиями. Для итоговой страницы дополнительно "
        "вызови hotel_latest_offers, hotel_rates и hotel_reviews для каждого "
        "финального отеля до get_trip_report. Не выдумывай цены, "
        "идентификаторы, "
