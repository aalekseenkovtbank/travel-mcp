...
def server_instructions() -> str:
    ...
    return (
        ...
        "и выборку отзывов с полями «Плюсы», «Минусы», «Кому подходит» для "
        ...
        "видимом ответе не скрывай детали, фото или reviewDigest; отсутствие "
        "данных обозначь предупреждением. Для HTML или Markdown после этого "
