# Метод GetHotelInfos (/internal\_api/v1/hotels/hotelinfolist)
...
| URL | /internal\_api/v1/hotels/hotel /internal\_api/v2/hotels/hotelinfolist |
| Метод | POST |
...
| images | string\[] | REQUIRED | Коллекция URL фотографий отеля |
...
|---|---|---|---|
| 1 | Документация существующего метода | [v. 35](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=3484043099) |  |
| 2 | Добавление недостающих значений Kind | [v. 38](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=3303420240&pageVersion=38) | THB-3915 |
| 3 | Добавление полей для ваучера на английском языке | [v. 40](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=3303420240) | THB-4224 |
| 4 | Расширение enum Способов оплаты (код 3 - Наличные и банковская карта) и формирования параметра description | [v.50](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=3303420240&pageVersion=50) | THB-4447 |
| 5 | HotelStaticApi не отдает mealName | [v.60](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=3303420240&pageVersion=60) | THB-7869 |
| 6 | Добавление полей для сертификации из PostgreSQL | [v.77](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=8275919964) | THB-11925 |
| 7 | Добавление параметров для флоу квартир |  | TTP-34113 |
| 8 | Доработка ручки hotelinfolist | [v.111](https://wiki.tcsbank.ru/pages/viewpage.action?pageId=8823362532) | TTP-35266 |
| 9 | Добавление условия формирования apartmentFacts, если у объекта несколько комнат | Текущая | TTP-39575 |